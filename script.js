    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "ללא שם מותג משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '0be87445-c2d2-4bcf-8cce-0b116846e5b6',
                    name: data.name || '',
                    email: data.email || '',
